...
const translations: Record<Language, Record<string, any>> = {
  en: {
    ...
    about: {
      ...
      desc: "Understand the application, our terms of usage, and the core principles of responsible training.",
      theAppTitle: "The Application",
      theAppDesc: "This trainer is a state-of-the-art mental gym built to simulate blackjack action in real-time. By managing computer players, simulating deck penetration, and requiring mathematical feedback of the count, the software is purely a cognitive training system. There is no gambling, no real money wagering, and no deposit mechanics.",
      termsTitle: "Terms of Use",
      termsDesc: "By using this trainer, you agree that it is provided strictly for educational, cognitive, and analytical purposes. You assume full personal responsibility for how you utilize these mathematical concepts. We do not endorse, facilitate, or promote real-money gaming or casino betting.",
  ...
  es: {
    ...
    about: {
      title: "Acerca del Entrenador",
      desc: "Entiende la aplicación, nuestros términos de uso y los principios fundamentales de la práctica responsable.",
      theAppTitle: "La Aplicación",
      theAppDesc: "Este entrenador es un gimnasio mental de última generación diseñado para simular la acción del blackjack en tiempo real. Al gestionar jugadores controlados por computadora, simular la penetración de barajas y requerir retroalimentación matemática del conteo, el software es puramente un sistema de entrenamiento cognitivo. No hay apuestas con dinero real ni mecanismos de depósito.",
      termsTitle: "Términos de Uso",
      termsDesc: "Al utilizar este entrenador, aceptas que se proporciona estrictamente para fines educativos, cognitivos y analíticos. Asumes la plena responsabilidad personal sobre cómo utilizas estos conceptos matemáticos. No respaldamos, facilitamos ni promovemos el juego con dinero real o las apuestas en casinos.",
